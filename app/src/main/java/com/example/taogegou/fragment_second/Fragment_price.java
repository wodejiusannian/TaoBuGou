...
public class Fragment_price extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener, UtilsInternet.XCallBack {
    ...
    private void loadMore(int page) {
        try {
            ...
            String searchPath = String.format(NetConfig.SEARCH_PATH, encode, 2, page);
